<?php
	...
	//$mcImageManagerConfig['filesystem.rootpath'] = '../../../../roopesh/newTestImage/'; // absolute or relative from this script path, required.
	$mcImageManagerConfig['filesystem.rootpath'] = "../../../../media/images/";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,flv,swf";
